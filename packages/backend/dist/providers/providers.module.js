...
exports.ProvidersModule = ProvidersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [provider_registry_service_1.ProviderRegistry, provider_router_service_1.ProviderRouter],
        exports: [provider_registry_service_1.ProviderRegistry, provider_router_service_1.ProviderRouter],
    })
], ProvidersModule);
